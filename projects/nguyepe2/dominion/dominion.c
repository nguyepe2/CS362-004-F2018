...
int villages(struct gameState *state, int handPos, int currentPlayer) {
...
int outposted(int handPos, int currentPlayer, struct gameState *state) {
      //set outpost flag
      state->outpostPlayed++;
...
*/		
    case village:
      villages(state, handPos, currentPlayer);
/*      //+1 Card
      drawCard(currentPlayer, state);
...
*/		
    ...
    case great_hall:
      greatHall(currentPlayer, state, handPos);
/*      //+1 Card
      drawCard(currentPlayer, state);
...
*/		
    ...
    case outpost:
      outposted(handPos, currentPlayer, state);
/*      //set outpost flag
      state->outpostPlayed++;
